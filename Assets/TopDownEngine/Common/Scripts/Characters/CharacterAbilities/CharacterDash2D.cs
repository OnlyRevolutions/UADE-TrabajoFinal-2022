		...
		protected virtual void HandleDashMode()
		{
			switch (DashMode)
			{
				...
				case DashModes.SecondaryMovement:
					_dashDestination = transform.position + (Vector3)_character.LinkedInputManager.SecondaryMovement.normalized * DashDistance;
					break;
				...
				case DashModes.MousePosition:
					...
					_dashDestination = transform.position + (_inputPosition - transform.position).normalized * DashDistance;
					break;
			}  
		}
