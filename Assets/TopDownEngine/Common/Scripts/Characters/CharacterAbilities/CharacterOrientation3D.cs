...
namespace MoreMountains.TopDownEngine
{
	...
	public class CharacterOrientation3D : CharacterAbility
	{
		...
		protected override void Initialization()
		{
			...
			{
				Debug.LogError("CharacterOrientation3D on "+name+" : you need to set a CharacterModel on your Character component, and/or specify MovementRotatingModel and WeaponRotatingModel on your CharacterOrientation3D inspector. Check the documentation to learn more about this.");
			}
