...
namespace MoreMountains.TopDownEngine
{
	...
	public class CharacterInventory : CharacterAbility, MMEventListener<MMInventoryEvent>
	{
		...
		protected virtual void GrabInventories()
		{
			...
			if (MainInventory != null) { MainInventory.SetOwner (gameObject); MainInventory.TargetTransform = InventoryTransform;}
			if (WeaponInventory != null) { WeaponInventory.SetOwner (gameObject); WeaponInventory.TargetTransform = InventoryTransform;}
			if (HotbarInventory != null) { HotbarInventory.SetOwner (gameObject); HotbarInventory.TargetTransform = InventoryTransform;}
		}
